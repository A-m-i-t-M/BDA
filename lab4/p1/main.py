...
def menu():
    while True:
        ...
        if choice == "1":
            transaction_data = input("Enter transaction (e.g., 'Sender: Alice, Receiver: Bob, Amount: $100'): ")
            iv, encrypted_transaction = cipher.encrypt(transaction_data)
            blockchain.add_transaction(encrypted_transaction, iv)
